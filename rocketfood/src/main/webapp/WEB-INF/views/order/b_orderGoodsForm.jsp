...
<form  name="form_order">	
	...
	<div class="detail_table">
		<table>
			<tbody>
				...
				<tr class="dot_line">
					<td>상품권 전환금</td>
					<td style="padding:5px"><input name="discount_sangpum" type="text"
						size="10" />원/0원 &nbsp;&nbsp;&nbsp; <input type="checkbox" /> 모두
						사용하기</td>
				</tr>
				<tr class="dot_line">
					<td>OK 캐쉬백 포인트</td>
					<td style="padding:5px"><input name="discount_okcashbag" type="text"
						size="10" />원/0원 &nbsp;&nbsp;&nbsp; <input type="checkbox" /> 모두
						사용하기</td>
				</tr>
				<tr class="dot_line">
					<td>쿠폰할인</td>
					<td style="padding:5px"><input name="discount_coupon" type="text"
						size="10" />원/0원 &nbsp;&nbsp;&nbsp; <input type="checkbox" /> 모두
						사용하기</td>
				</tr>
			</tbody>
	...
	<br>
	<table class="list_view" style="background: #ccffff; width: 80%">
		<tbody>
